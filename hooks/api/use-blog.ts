...
/**
 * Interface untuk metadata paginasi blog
 */
interface BlogMeta {
  totalItems: number;
  itemsPerPage: number;
...
/**
 * Hook untuk mengambil daftar blog posts
 * @param page - Halaman yang ingin diambil
 * @param limit - Jumlah item per halaman
 * @param search - Kata kunci pencarian
 * @param status - Status blog post (draft/published)
 * @param kategori - Kategori blog post
 * @returns Data blog posts, metadata paginasi, status loading, error, dan fungsi refetch
 */
...
/**
 * Hook untuk mengambil detail blog post berdasarkan ID atau slug
 * @param id - ID blog post
 * @param slug - Slug blog post
 * @returns Data detail blog post, status loading, error, dan fungsi refetch
 */
