...
// Tipe untuk MotorcycleFilterContext
...
interface MotorcycleFilterProviderProps {
  children: ReactNode
}
...
/**
 * Provider untuk filter motor
 * @param children - React children nodes
 * @returns MotorcycleFilterProvider component
 */
export function MotorcycleFilterProvider({ children }: MotorcycleFilterProviderProps) {
...
/**
 * Hook untuk menggunakan MotorcycleFilterContext
 * @returns MotorcycleFilter context values
 * @throws Error jika digunakan di luar MotorcycleFilterProvider
 */
export function useMotorcycleFilter() {
  const context = useContext(MotorcycleFilterContext)
  
  if (context === undefined) {
    throw new Error("useMotorcycleFilter must be used within a MotorcycleFilterProvider")
  }
