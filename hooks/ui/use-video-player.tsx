...
/**
 * Hook untuk mengelola player video
 * @param options - Opsi konfigurasi player video
 * @returns Object dengan ref video, status player, dan kontrol player
 */
