...
export default function BookingHistoryPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span
        className={`px-2 py-1 text-xs rounded border flex items-center ${statusInfo.className}`}
      >
        {statusInfo.icon}
        {statusInfo.label}
      </span>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="md:max-w-xl">
                ...
                <p className="text-muted-foreground text-lg max-w-xl">{t('enterPhoneNumber')}</p>
              </div>
                ...
                <div className="relative p-1 rounded-xl">
                  <Card className="bg-card border border-primary/10 shadow-xl relative z-10 w-full">
                    <CardHeader className="border-b border-border/10 pb-4">
                      ...
                      <CardDescription>{t('enterPhoneNumber')}</CardDescription>
                    </CardHeader>
