...
import { AlertCircle, Bike, Calendar, Search } from 'lucide-react';
            ...
            >
              <motion.div
                ...
                className={`flex items-center justify-between border-b border-border/50 pb-6 relative ${
                  showResultIndicator
                    ? 'after:absolute after:inset-0 after:bg-primary/5 after:animate-pulse after:rounded-lg after:-z-10'
                    : ''
                }`}
              >
                <div>
              ...
              <motion.div variants={itemVariants}>
                {isLoading ? (
                  ...
                  <Alert variant="destructive" className="bg-red-500/10 border-red-500/20">
                    ...
                    <AlertDescription className="text-red-500/80">{error}</AlertDescription>
                  </Alert>
                ) : (
                  <AvailabilityResults
                    ...
                    _onBook={motorcycle =>
                      router.push(
                        `/availability/booking?unitId=${motorcycle.id}&startDate=${tanggalMulai}&endDate=${tanggalSelesai}`
                      )
                    }
                  />
                )}
