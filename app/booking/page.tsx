      ...
      <div className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <Card className="bg-card border-border">
              <CardContent className="p-6">
                <Skeleton className="h-8 w-1/3 mb-4 bg-secondary" />
          ...
          <div>
            <Card className="bg-card border-border">
              <CardContent className="p-6">
                <Skeleton className="h-8 w-1/2 mb-4 bg-secondary" />
                <Skeleton className="h-4 w-full mb-2 bg-secondary" />
                <Skeleton className="h-4 w-full mb-2 bg-secondary" />
                <Skeleton className="h-4 w-full mb-2 bg-secondary" />
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <div>
                  <p className="text-muted-foreground text-sm">Merk & Model</p>
                  <p className="font-medium">{motorcycle.jenis?.merk} {motorcycle.jenis?.model}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Plat Nomor</p>
                  <p className="font-medium">{motorcycle.platNomor}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Harga Sewa Per Hari</p>
                  <p className="font-medium">Rp {motorcycle.hargaSewa.toLocaleString()}</p>
                </div>
                <div>
                  <p className="text-muted-foreground text-sm">Periode Sewa</p>
