...
import { ChevronRight, Star, Clock, Gauge, ArrowRight } from 'lucide-react'
...
export default function FeaturedMotorcycles() {
  ...
  const enhancedMotorcycles = displayMotorcycles.map((motorcycle) => {
    ...
    const kategori = motorcycle.cc <= 200 
      ? "Scooter" 
      : motorcycle.cc <= 500 
        ? "Sport" 
        : "Naked";
    ...
    const harga = motorcycle.unitMotor && motorcycle.unitMotor.length > 0
  ...
  const filteredMotorcycles =
    activeCategory === "all" ? enhancedMotorcycles : enhancedMotorcycles.filter((m) => m.kategori === activeCategory)
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12">
          ...
          >
            <Link href="/motorcycles">
              <Button variant="outline" className="border-primary/20 hover:border-primary hover:bg-primary/5 group">
                {t("viewAll")}
                    ...
                    <CardContent className="p-5">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center text-yellow-500">
                          ...
                          <span className="text-sm ml-1 font-medium">{motorcycle.rating?.toFixed(1)}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between text-sm text-muted-foreground mb-2">
                        ...
                        <div className="flex items-center">
                          ...
                          <span>{motorcycle.unitMotor && motorcycle.unitMotor.length > 0 
                    ...
                    <CardFooter className="px-5 py-4 border-t">
                      <div className="w-full flex items-center justify-between">
                        <div className="font-bold text-lg text-primary">
                          {formatPrice(motorcycle.unitMotor && motorcycle.unitMotor.length > 0 
                            ? motorcycle.unitMotor[0].hargaSewa 
