          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            >
              <Card className="overflow-hidden border-primary/10 shadow-lg shadow-primary/5">
                <div className="bg-primary/5 p-6 border-b border-primary/10">
                  <h3 className="text-2xl font-semibold text-foreground">{t("contactFormTitle")}</h3>
                ...
                <CardContent className="p-6">
                  {submitSuccess ? (
                    ...
                    >
                      ...
                      <h4 className="font-semibold text-success text-xl mb-2">{t("messageSentSuccess")}</h4>
            ...
            >
              <Card className="overflow-hidden border-primary/10 shadow-lg shadow-primary/5 h-full">
                ...
                <CardContent className="p-6">
                  <h3 className="text-2xl font-semibold mb-6 text-foreground">{t("ourLocation")}</h3>
