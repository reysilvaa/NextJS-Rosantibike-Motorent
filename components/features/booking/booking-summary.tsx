...
export default function BookingSummary({ motorcycle, startDate, endDate }: BookingSummaryProps) {
  return (
    <div className="bg-secondary/20 rounded-lg p-4 space-y-2 border border-border mb-4">
      ...
      <div className="flex justify-between">
        ...
        <span className="text-sm font-medium">Rp {motorcycle.hargaSewa.toLocaleString()}/hari</span>
      </div>
    </div>
  );
}
