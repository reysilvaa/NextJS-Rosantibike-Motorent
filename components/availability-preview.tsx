        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 max-w-3xl mx-auto">
            <div className="flex-1">
              <label className="block text-sm font-medium text-muted-foreground mb-2">{t("startDate")}</label>
              <Popover>
            ...
            <div className="flex-1">
              <label className="block text-sm font-medium text-muted-foreground mb-2">{t("endDate")}</label>
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
